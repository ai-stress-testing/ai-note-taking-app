...
export const COMMANDS: CommandDef[] = [
  ...
  // ── Question workflow ───────────────────────────
  { name: "/question", description: "Insert a Question template", ai: false, localHint: "tpl:question" },
  { name: "/part",     description: "Add a new Part to current question", ai: false, localHint: "tpl:part" },
  { name: "/calc",     description: "Insert a calc blockquote line", ai: false, localHint: "tpl:calc" },
  { name: "/math",     description: "Insert inline MathJax expression", ai: false, localHint: "tpl:math" },
  { name: "/>",        description: "Close current item (question/math/calc/vocab)", ai: false, localHint: "tpl:close" },

  // ── Vocab / spaced repetition (stubs for later) ─
  { name: "/vocab", description: "Insert a Vocab entry template", ai: false, localHint: "tpl:vocab" },
  ...
  // ── Layout ──────────────────────────────────────
  { name: "/split",  description: "Split view (up to 4 panes)", ai: false, localHint: "layout:split" },
  { name: "/canvas", description: "Insert a drawable canvas (purple ink)", ai: false, localHint: "tpl:canvas" },

  // ── Buffer / IO ─────────────────────────────────
  { name: "/export",    description: "Download workspace",       ai: false, localHint: "export" },
  { name: "/export-md", description: "Export focused file as Markdown", ai: false, localHint: "export-md" },
];
